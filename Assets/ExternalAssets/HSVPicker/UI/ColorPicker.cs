...
public class ColorPicker : MonoBehaviour
{
    ...
    private void Awake()
    {
        if (acceptBtn != null)
        {
            btnTxt = acceptBtn.GetComponentInChildren<Text>();
    ...
    {
        acceptBtn.image.color = color;
        btnTxt.color = new Color(-0.5f+color.r>0? -0.5f + color.r : 0.5f +color.r, -0.5f + color.g > 0 ? -0.5f + color.g : 0.5f + color.g, -0.5f + color.b > 0 ? -0.5f + color.b : 0.5f + color.b, color.a);
    }
